    ...
    transfer.prototype = {
        ...
        initContainer: function () {
            ...
            var containerHtml = ['<div class="col-sm-5 transferBox">',
                '<h3 class="unselectTitle" style="margin: 0;padding: 5px 0 10px 0;text-align: left;color: #41a17d;">' + this.unselectTitle + '<span style="margin-left: 5px;">(<span id="checkedNum1"></span><span id="unselectTotalNum"></span>)</span></h3>',
                '<table id="transferUnselectTable"></table>',
                '</div>',
                '<div class="col-sm-2 transferBtn" style="height: 100%;padding: 0px 20px;box-sizing: border-box">',
                '<div class="btnList">',
                '<span class="btn btn-default  forwardBtn" > > 向右<i class="glyphicon glyphicon-forward"></i></span>',
                '<span class="btn btn-default  backwardBtn" > < 向左 <i class="glyphicon glyphicon-backward"></i></span>',
                '</div>',
                '</div>',
                '<div class="col-sm-5 transferBox">',
                '<h3 class="selectTitle" style="margin: 0;padding: 5px 0 10px 0;text-align: left;color: #41a17d;">' + this.selectTitle + '<span style="margin-left: 5px">(<span id="checkedNum2"></span><span id="selectTotalNum"></span>)</span></h3>',
        ...
        classifyData: function () {
            ...
            if (!this.option.dataSource) {
                console.error('dataSource参数为必填项，请检查');
                return false;
            }
        ...
        getData: function (type, arr) {
            if (!type) {
                console.error('请填写想要返回的数据名称unselectData或selectData');
                return false;
            }
